...
public final class MultiTypeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position, @Nullable final List<Object> payloads) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull final RecyclerView.ViewHolder genericHolder) {
        getTypeAdapterForType(genericHolder.getItemViewType()).onAttach(genericHolder);
    }

    @Override
    public void onViewDetachedFromWindow(@NonNull final RecyclerView.ViewHolder genericHolder) {
    ...
    boolean isDataTheSame(final Object data1, final Object data2) {
        // Are the type adapters the same
        if (getItemTypeForData(data1) == getItemTypeForData(data2)) {
            // Is the data in them equal
