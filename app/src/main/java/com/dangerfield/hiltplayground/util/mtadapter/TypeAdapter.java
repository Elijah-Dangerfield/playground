...
import com.dangerfield.hiltplayground.util.mtadapter.interfaces.Function2;
import com.dangerfield.hiltplayground.util.mtadapter.interfaces.Function3;
...
public abstract class TypeAdapter<D, V extends RecyclerView.ViewHolder> {
    ...
    public Object getChangePayload(
            @NonNull final D oldData,
            @NonNull final D newData,
            final Bundle diffBundle
    ) {
        return null;
    }
